...
export default function App() {
  ...
  const songData = [
    ...
    { title: 'Her', artist: 'JVKE', image: '/moments/her.png', audio: '/music/her.mp3', gif: '/moments/cat14.gif' },
  ];
  ...
  function handlePhotoBoothOpen() {
    setPhotoBoothSliding(true);
    setTimeout(() => {
      setShowPhotoBooth(true);
      setPhotoBoothSliding(false);
    }, 700);
  }

  function handlePhotoBoothFalling() {
...
<div style={{ fontFamily: "'Libre Baskerville', serif", fontStyle: 'italic', fontSize: 'clamp(1.5rem, 3vw, 2rem)', color: '#3a2a24', marginBottom: '1rem', fontWeight: 600, textAlign: 'center' }}>
      ...
      {showPhotoBooth && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 1500, background: '#fff', overflowY: 'auto' }}>
          <div style={{ position: 'relative', width: '100%', minHeight: '100vh' }}>
            <FlowersFall onFalling={handlePhotoBoothFalling} />
            <PhotoBooth revealed={photoBoothRevealed} onTakePhotos={() => setShowActualBooth(true)} />
          </div>
        </div>
      )}
